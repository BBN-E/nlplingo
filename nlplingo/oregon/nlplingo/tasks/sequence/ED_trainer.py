...
from nlplingo.oregon.nlplingo.tasks.sequence.ED_model import EDModel
from nlplingo.oregon.nlplingo.tasks.sequence.generator import TriggerGenerator
...
class EDTrainer(object):
    def __init__(self, opt, logger, biw2v_map, eval_mode=False, train_examples=None, train_docs=None, dev_examples=None, dev_docs=None, label_map=None):
        ...
        self.opt = opt
        self.logger = logger
        self.model = EDModel(opt, label_map)
        ...
        if not eval_mode:
            ...
            self.train_iterator = TriggerGenerator(opt, self.model.xlmr_embedding, train_examples, train_docs, label_map, biw2v_map, is_eval_data=False)
            print('ED model : Training data: {}'.format(self.train_iterator.num_examples))

            self.dev_iterator = TriggerGenerator(opt, self.model.xlmr_embedding, dev_examples, dev_docs, label_map, biw2v_map, is_eval_data=True)
