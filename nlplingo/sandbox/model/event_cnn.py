...
from nlplingo.sandbox.model import MySelect
...
class EventExtractionModel(object):
    ...
    def __init__(self, params, event_domain, embeddings):
        ...
        # Lexical feature is the eventtrigger token and its surrounding context tokens.

        # Sentence feature is all the tokens in the sentences and the distance
        #  of each token to the eventtrigger token.
    ...
    #
    #     if self.verbosity == 1:
    #         print('\nevent_cnn.py : ExtractionModel.fit()')
    ...
    #     print('\ntrigger_class_dm_pool_model.py : ExtractionModel().run_weight_boost_model()')
    #     print('- train=', train)
    #     print('- test=', test)
