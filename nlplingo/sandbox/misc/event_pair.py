...
class EventPairData(object):
    def __init__(self, trigger_examples, pair_examples, data, data_list, label):
        """
        :type trigger_examples: list[nlplingo.tasks.event_trigger.EventTriggerExample]
        :type pair_examples: list[nlplingo.tasks.eventpair.EventPairExample]
...
class EventPairGenerator(object):
    ...
    def generate_train(self, examples):
        ...
        ret = []
        """:type: list[nlplingo.tasks.eventpair.EventPairExample]"""

        # first, let's group examples by event_type
        example_by_event_type = defaultdict(list)
        """:type: dict[str, list[nlpling.tasks.event_trigger.EventTriggerExample]]"""
    ...
    #     """
    #     :type examples: list[tasks.event_mention.EventMentionExample]
    #     """
    #     self.statistics.clear()
    #     number_positive = 0
    #     number_negative = 0
    #
    #     ret = []
    #     """:type: list[tasks.eventpair.EventPairExample]"""
    #
    #     for eg in examples:
...
class EventPairExample(object):
    ...
    def __init__(self, params, eg1, eg2, label_string):
        ...
        :type eg1: nlplingo.tasks.event_trigger.EventTriggerExample
        :type eg2: nlplingo.tasks.event_trigger.EventTriggerExample
