...
# Load trained eventtrigger and eventargument role models
triggerModelFilename = 'eventtrigger-classification-run0-epoch5.pickle'
    ...
    for seg in segmentSize:
        for i in range(seg):
            ...
            if not roleType in adataset.corpus.domain.getEventRoles(eventType):
                print('Role {} not in tasks {}'.format(roleType, eventType))
