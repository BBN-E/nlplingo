...
if __name__ == "__main__":
    ...
    from nlplingo.sandbox.misc.event_trigger import EventTriggerGenerator
    from nlplingo.sandbox.misc.event_argument import EventArgumentGenerator
    from nlplingo.tasks.event_domain import CyberDomain

    from nlplingo.sandbox.misc.train_test import load_trigger_model
    from nlplingo.sandbox.misc.train_test import load_argument_model
